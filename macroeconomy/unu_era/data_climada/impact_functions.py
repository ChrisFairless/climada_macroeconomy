...
def get_climada_flood_impact_function(country):
...
def get_climada_flood_impact_function_set(country):
    return ImpactFuncSet([get_climada_flood_impact_function(country)])
